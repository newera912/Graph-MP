...
root="F:/workspace/git/Graph-MP/outputs/mesonetPlots/temp_CaseStudy/CP/"
...
for i,m in enumerate(methods):
    ...
    for s in [2,3]:
        ...
        f1=[]
        print s
        outfile=root+str(s)+"/"+m+"_s_"+str(s)+"_Plot2.png"
        for mwin in [12,18,24,30,36]:
            fileName=root+str(s)+"/prf1/"+m+"_s_"+str(s)+"_wMax_"+str(mwin)+"_filter_TIncld_0.7.txt"
