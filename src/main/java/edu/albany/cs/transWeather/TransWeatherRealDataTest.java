...
//				}
	...
	public static void testSingleFileChangePoint(String singleFile, String resultFileName,String gtFileName,String prf1File,int mwin,int sss) {
		long startTime = System.nanoTime();
		FileWriter fileWriter=null;
		FileWriter prf1Writer=null;
		APDMInputFormat apdm = new APDMInputFormat(singleFile);
...
//				}
	...
	public static void CaseStudy(int maxwin,int sss){
		...
		String prf1Filepath=sss+"/prf1/debugSFile_PRF1_result-"+methodType+"_baseMeanDiff_20_s_"+sss+"_wMax_"+maxwin+"_filter_TIncld_0.7.txt";
		String resultFilepath=sss+"/debugSfile_TopK_result-"+methodType+"_baseMeanDiff_20_s_"+sss+"_wMax_"+maxwin+"_filter_TIncld_0.7.txt";
		try {
